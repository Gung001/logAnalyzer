package com.lxgy.storm.integration.redis;
 ...
 * @author Gryant
 */
public class LocalRedisWordCount {
    ...
    public static void main(String[] args) {
        ...
        localCluster.submitTopology("LocalRedisWordCount", new Config(), builder.createTopology());
    }
}
